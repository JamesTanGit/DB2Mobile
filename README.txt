...
4. Extract the contents of the .ZIP file (submission) until you end up with a single folder titled name_name_PhaseIII
...
10. Run the app by going to the top of Android Studio and clicking Run -> 'Run app' using your own device 
