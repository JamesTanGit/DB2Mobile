...
public class StudentUpdateStudentInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_update_student_info);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                getJSON("http://192.168.0.21/DB2Mobile/php/StudentUpdateStudentInfo.php");
            }
        });
    }
